...
//                                    System.out.println(Integer.parseInt(pr.substring(totPriceStart, totPriceEnd)));
                                    items.add(new Item(key,(pr.substring(supplierStart, supplierEnd)),Integer.parseInt(pr.substring(priceStart, priceEnd)), Integer.parseInt(pr.substring(amountStart, amountEnd)),Integer.parseInt(pr.substring(totPriceStart, totPriceEnd))));
